        ...
        <div className="md:flex md:items-center lg:justify-between">
          <div className="md:w-[478px]">
            ...
            >
              ...
              <button onClick={() => handleNavigation('quienes-somos')} className="btn bg-transparent text-black px-4 py-2 rounded-lg font-medium inline-flex items-center justify-center tracking-tight gap-1">
